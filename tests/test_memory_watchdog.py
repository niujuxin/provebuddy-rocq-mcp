...
class TestMemoryWatchdogBreach:
    ...
    async def test_high_rss_triggers_abort(self, monkeypatch):
        ...
        monkeypatch.setattr(core_pet, "_ensure_pet", lambda ls: mock_pet)
        ...
        monkeypatch.setattr(core_pet, "_invalidate_pet", _track_invalidate)
        monkeypatch.setattr(core_pet, "_force_release_pet_lock", _track_release_lock)
    ...
    async def test_partial_state_merged_on_memory_abort(self, monkeypatch):
        ...
        monkeypatch.setattr(core_config, "ROCQ_MAX_PET_RSS_MB", 50)
        ...
        monkeypatch.setattr(core_pet, "_ensure_pet", lambda ls: mock_pet)
        monkeypatch.setattr(
            core_pet, "_invalidate_pet", lambda ls: ls.update(pet_client=None)
        )
